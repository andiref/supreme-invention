...
import { YIELD_TARGET, DPPM_LIMIT, REPORT_MAX_WEEKS, CHART_COLORS } from '../../brain/index.js';
...
function CustomerSection({ customer, data, color }) {
  ...
  return (
    <div style={{ display: 'flex', borderTop: '1px solid var(--yc-border)', paddingTop: 16, marginTop: 16 }}>
